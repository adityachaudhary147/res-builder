...
const Theme7View: React.FC<PreviewProps> = ({ message }: PreviewProps) => {
    ...
    <>
      <div>
        <div className="preview" >
          <div id='preview'>
          <div className="header-preview-7">
          <div className={`preview-heading-${headAlign.headalign}`}>
              <div className="full-name-7">{head.name}  
              </div>
              <span className="profession-7">{head.statement} </span>
          ...
          <div className="preview-page-content-7"  >
            <h2 className="title-preview-7">Education </h2>
            ...
            <h2 className="title-preview-7">Experience </h2>
            {experience.exp &&
            ...
            <h2 className="title-preview-7">Skills</h2>
