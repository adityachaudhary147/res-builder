...
const Theme6View: React.FC<PreviewProps> = ({ message }: PreviewProps) => {
    ...
    <>
      <div>
        <div className="preview" >
          <div id='preview'>
          <div className="header-preview-6">
          <div className={`preview-heading-${headAlign.headalign}`}>
          <div className="full-name-6">{head.name}  
              <span className="profession-6">{head.statement} </span></div>
          ...
          <div className="preview-page-content-6"  >
            
            
            
            
            
            <h2 className="title-preview-6">Education </h2>
            ...
            <h2 className="title-preview-6">Experience </h2>
            {experience.exp &&
              experience.exp.map((val) => {
                return (
                  <>
                    ...
                    <div className="duration-6">{val.duration}</div>
                      <div>
            ...
            <h2 className="title-preview-6">Skills</h2>
